 ...
 */
function StudioHeader({ title, description, actions }: StudioHeaderProps) {
  return (
...
/** 图文编辑器附加参数。 */
interface ImageTextEditorProps extends MutableStudioProps {
  /** Ant Design 消息 API。 */
  messageApi: ReturnType<typeof message.useMessage>[0]
}

/**
 * 图文编辑器；支持三种拆卡方式、主题、尺寸、缩放和 PNG 导出。
 */
  ...
  return (
    <>
      ...
      <div className="editor-preview-grid studio-editor-grid">
        ...
        <section
          className={`card-preview-scroll xhs-preview-${xiaohongshuPreview}`}
          aria-label="图文卡片预览"
        >
          ...
          <div className={xiaohongshuPreview === 'feed' ? 'xhs-feed-grid' : ''}>
